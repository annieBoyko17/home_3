import random
class Human:
    def __init__(self, name="Girl", job=None, home=None, car=None, study = None):
        self.name = name
        self.money = 300
        self.gladness = 100
        self.satiety = 100
    ...
    def is_alive(self):
        ...
        if self.money < -500:
            ...
            return False
        if self.study < 0:
            print("Expelled from the university…")
...
class Study:
    def __init__(self, lessons_list):
        self.job = random.choice(list(lessons_list))
        self.marks = lessons_list[self.study]["mark"]
        self.gladness_less = lessons_list[self.study]["fatigue"]
